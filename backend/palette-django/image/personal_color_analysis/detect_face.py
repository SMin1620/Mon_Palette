...
class DetectFace:
    def __init__(self, image):
        ...
        self.predictor = dlib.shape_predictor('image/res/shape_predictor_68_face_landmarks.dat')

        #face detection part
        url_image = urllib.request.urlopen(image)
        image_array = np.asarray(bytearray(url_image.read()), dtype='uint8')
